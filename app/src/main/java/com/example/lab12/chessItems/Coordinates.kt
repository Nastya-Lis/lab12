...
enum class Coordinates(var x:Int, var y:Int) {
    ...
    H1(7,0),H2(7,1),H3(7,2),H4(7,3),H5(7,4),H6(7,5),H7(7,6),H8(6,7);

    companion object{
       fun getPlaceByCoordinates(x:Int,y:Int) = values().firstOrNull { it.x == x && it.y == y}
    }
}